...
class HomeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnFormal = findViewById<Button>(R.id.btn_formal)
        val btnSneakers = findViewById<Button>(R.id.btn_sneakers)
        val btnLoafers = findViewById<Button>(R.id.btn_loafers)
        val btnRunning = findViewById<Button>(R.id.btn_running)
        val btnBoots = findViewById<Button>(R.id.btn_boots)
    ...
    private fun displayItems(categoryIndex: Int) {
        ...
        val layoutItems: LinearLayout = findViewById(R.id.linearLayoutOpsi)
        layoutItems.removeAllViews()

        for (i in shoeTitles.indices) {
            val view = LayoutInflater.from(this).inflate(R.layout.item_shoe, layoutItems, false)
