...
class ListProduct : AppCompatActivity() {
    ...
    private fun generateDummyProductList(): List<Product_kt> {
        return listOf(
            ...
            Product_kt("https://compass-ecom-bucket.s3-ap-southeast-1.amazonaws.com/images/productdetail/f95170a5f613fa35ca5f3e2323a932cff230713b.png", "Compas", "Compass Velocity Black", "Size 40", "Open - Order", "Rp 798.000,00", "rp 718.000,00", "4.3"),
